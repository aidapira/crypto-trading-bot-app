      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            ...
            return _context8.abrupt("return", (0, _fs.readFileSync)(fixturePath, 'utf8'));
...
describe('JSON', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            jsonAst = (0, _jsonToAst["default"])(rawJson, {
              loc: true
            });
  ...
  it('should not throw error when children is array', function () {
    ...
    var jsonAst = (0, _jsonToAst["default"])(rawJsonWithArrayItem, {
      loc: true
    });
