...
export declare class AccountAPI {
     ...
     */
    getAccountHistory(accountId: string, pagination?: Pagination): Promise<PaginatedData<AccountHistory>>;
    /**
     ...
     */
    getHolds(accountId: string, pagination?: Pagination): Promise<PaginatedData<Hold>>;
    /**
