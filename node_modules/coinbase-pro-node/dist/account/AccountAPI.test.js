...
describe('AccountAPI', () => {
    ...
    beforeAll(() => {
        (0, nock_1.default)(global.REST_URL).persist().get(AccountAPI_1.AccountAPI.URL.ACCOUNTS).query(true).reply(200, JSON.stringify(GET_200_json_4.default));
    ...
    describe('listCoinbaseAccounts', () => {
        it('returns the list of the coinbase accounts for a given user', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, nock_1.default)(global.REST_URL).get(AccountAPI_1.AccountAPI.URL.COINBASE_ACCOUNT).reply(200, response);
