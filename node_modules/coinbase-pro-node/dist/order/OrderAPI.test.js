...
describe('OrderAPI', () => {
    ...
    describe('getOrder', () => {
        ...
        it('returns null if an order cannot be found', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, nock_1.default)(global.REST_URL).get(`${OrderAPI_1.OrderAPI.URL.ORDERS}/123`).query(true).reply(404);
        ...
        it('rethrows errors with status code other than 404', () => __awaiter(void 0, void 0, void 0, function* () {
            (0, nock_1.default)(global.REST_URL).get(`${OrderAPI_1.OrderAPI.URL.ORDERS}/123`).query(true).reply(403);
            try {
