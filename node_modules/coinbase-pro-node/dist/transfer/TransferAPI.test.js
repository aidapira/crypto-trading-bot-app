...
describe('TransferAPI', () => {
    ...
    describe('getTransfers', () => {
        it('returns withdrawals', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, nock_1.default)(global.REST_URL).get(TransferAPI_1.TransferAPI.URL.TRANSFERS).query(true).reply(200, response);
    ...
    describe('getTranfer', () => {
        it('returns a withdrawal', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, nock_1.default)(global.REST_URL).get(path).reply(200, response);
